...
function Cad(){
	...
	this.conectar=function(){
		let cad=this;
		//mongodb+srv://batalla:<password>@cluster0.jagipih.mongodb.net/?retryWrites=true&w=majority
		mongo.connect("mongodb+srv://batalla:conocido@cluster0.jagipih.mongodb.net/?retryWrites=true&w=majority",{ useUnifiedTopology: true },function(err,database){
			if(!err){
